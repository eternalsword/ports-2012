...
# $Header: /var/cvsroot/gentoo-x86/net-libs/libtorrent/libtorrent-0.13.3.ebuild,v 1.1 2013/03/22 08:28:17 patrick Exp $

EAPI=5

inherit eutils autotools libtool toolchain-funcs

DESCRIPTION="BitTorrent library written in C++ for *nix"
HOMEPAGE="http://libtorrent.rakshasa.no/"
EGIT_REPO_URI="https://github.com/eternalsword/libtorrent.git"
inherit git-2
