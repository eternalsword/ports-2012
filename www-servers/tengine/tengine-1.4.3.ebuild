...
HTTP_LUA_MODULE_PV="0.7.17"
HTTP_LUA_MODULE_P="ngx_lua-${HTTP_LUA_MODULE_PV}"
HTTP_LUA_MODULE_SHA1="a768a65"
...
CHUNKIN_MODULE_PV="0.23rc4"
CHUNKIN_MODULE_SHA1="1a64508"
...
SRC_URI="https://github.com/alibaba/tengine/archive/${P}.tar.gz
...
src_prepare() {
	...
	if use nginx_modules_http_passenger; then
		mv "${WORKDIR}/FooBarWidget-passenger-9e343ac" "${WORKDIR}"/passenger-"${PASSENGER_PV}";
